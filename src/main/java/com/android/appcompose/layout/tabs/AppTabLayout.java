...
import static com.android.appcompose.layout.tabs.TabType.ICON_ONLY;
import static com.android.appcompose.layout.tabs.TabType.TEXT_ONLY;
...
public class AppTabLayout extends HorizontalScrollView {
    ...
    private final AppTabStrip mTabStrip;
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        if (viewPager != null) {
            ...
            AppFragmentPagerAdapter adapter = (AppFragmentPagerAdapter) mViewPager.getAdapter();
            if (actionBar != null)
    ...
    private void populateTabStrip() {
        final AppFragmentPagerAdapter adapter = (AppFragmentPagerAdapter) mViewPager.getAdapter();
